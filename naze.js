...
const nyoutube = ('© Mochi\nYoutube/Sc :\nhttps://youtube.com/c/MochiEx')  //ubah di config biar ngk emror
...
//PEMBATAS ADMIN & OWNER=======================================
  ...
  naze.sendMessage(m.chat, buttonMessage, {quoted: fkontak})
            ...
            case 'setowner': {
               if (!isCreator) throw mess.owner
               if (m.text.includes('@')) return m.reply(`*Invalid!*\n\n*Pake Nomer Woy*\n*Jangan Pakai Tag!*`)
               if (!text) throw `Example : ${prefix + command} 6282327020033`
              global.owner = text
